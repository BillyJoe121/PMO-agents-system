...
•	El botón verde final debe disparar un Modal de confirmación estricto: "Está a punto de aprobar los artefactos y cerrar el proyecto. Para modificar de nuevo el proyecto lo encontrará en la sección de proyectos terminados. ¿Desea proceder?".
